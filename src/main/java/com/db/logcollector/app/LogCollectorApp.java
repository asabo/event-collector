...
import com.db.logcollector.rest.resource.LogCollectorRestResourceConfig;

public final class LogCollectorApp {
	private static final Logger LOG = Log.getLogger(LogCollectorApp.class);
	...
	public void setup() {
		...
		String webDir = LogCollectorApp.class.getClassLoader().getResource("webapp").toExternalForm();
	...
	public static void main(String args[]) throws Exception {
		...
		LogCollectorApp theServer = new LogCollectorApp();
		theServer.setup();
		theServer.start();

		LOG.info("SX3 Server finished ...");
	}
